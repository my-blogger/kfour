...
(function ($) {
    ...
    $.stickToMe = function ( configs ) {
        ...
        var defaults = {
            ...
            trigger: ['top'],
            maxtime : 0,
            mintime : 5000,  // минимальное время просмотра страницы перед показом
            delay: 0,
            interval: 60000, // интервал между показами
            maxamount : 1,   // максимальное число показов за одну сессию
            cookie : true,
            bgclickclose : true,
            escclose : true,
            onleave : function (e) {},
                                ...
                                if (chromealert)
                                {
                                    ...
                                    if (settings.cookie == false || (settings.cookie == true && (cookiehowm < settings.maxamount || settings.maxamount == 0)))
                                    {
                                        ...
                                        if (settings.cookie == true)
                                        {
											...
											cookiehowm++;
											document.cookie = "ck_stick_visit="+cookiehowm+"; expires="+ cookie_date.toGMTString() +"; path=/";
...
$(document).ready(function(){ $.stickToMe({ layer: '#stickLayer' }); });